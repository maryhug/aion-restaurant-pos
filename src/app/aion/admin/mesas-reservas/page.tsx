...
export default function AdminTablesReservationsPage() {
  ...
  return (
    <div className="space-y-3">
      <ReservationBoard tables={data.tables} reservations={data.reservations} />

      <section className="grid gap-3 lg:grid-cols-2">
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold">Mesas</h3>
            <button
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold">Reservas</h3>
            <button
              ...
              { key: "status", label: "Estado" },
              {
                ...
                render: (r) => (
                  <div className="flex gap-1">
                    ...
                    <button
                      onClick={() => deleteReserva(r as unknown as Reservation)}
                      className="rounded border border-red-300 px-2 py-0.5 text-xs text-red-700 hover:bg-red-50"
                    >
                      Eliminar
                    </button>
